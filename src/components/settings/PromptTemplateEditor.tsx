  ...
  const renderForm = (onSubmit: () => void) => (
    <div className="p-4 bg-surface-secondary/30 rounded-xl border border-border mb-3 space-y-3 shadow-sm animate-in fade-in slide-in-from-top-2">
      ...
      <textarea
        ...
        rows={3}
        className="border border-border rounded-lg px-3 py-2.5 w-full bg-surface text-text placeholder-text-secondary/50 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm resize-none transition-all"
      />
